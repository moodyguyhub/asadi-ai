...
export function TopNav() {
  return (
    <nav className="sticky top-0 z-50 -mx-4 sm:-mx-6 lg:-mx-10 px-4 sm:px-6 lg:px-10 bg-[rgba(var(--background),0.8)] backdrop-blur-xl border-b border-white/[0.06]">
      <div className="flex items-center justify-between h-16 max-w-6xl mx-auto">
        <Link 
          href="/" 
          className="font-semibold text-white text-sm tracking-wide hover:text-[rgb(var(--accent))] transition-colors duration-200"
        >
          {site.name}
        </Link>
